...
{
	public class badsoul : ModProjectile
	{
        ...
        {
            Main.PlaySound(SoundID.NPCKilled, projectile.position, 6);
            ...
            for (int i = 0; i < NUM_DUSTS; i++)
            {
                ...
                dust = Main.dust[Terraria.Dust.NewDust(position, 3, 3, 31, Main.rand.NextFloat(-5f, 5f), Main.rand.NextFloat(-5f, 5f), 110, new Color(255, 255, 255), 1f)];
                dust.noGravity = true;
        ...
        public override void AI()
        {
            ...
            Dust dust2;
            dust2 = Terraria.Dust.NewDustPerfect(projectile.Center, 267, new Vector2(0f, 0f), 97, new Color(255, 255, 255), 1f);
            dust2.noGravity = true;
            dust2.shader = GameShaders.Armor.GetSecondaryShader(55, Main.LocalPlayer);
